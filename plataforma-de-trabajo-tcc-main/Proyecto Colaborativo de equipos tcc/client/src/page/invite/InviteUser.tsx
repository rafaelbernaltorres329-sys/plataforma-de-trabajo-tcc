          ...
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-xl">
                Hola! has sido  invitado a unirte a  este espacio de trabajo!
              </CardTitle>
              <CardDescription>
                Parece que necesitas iniciar sesión en tu cuenta de TeamSync para
                unirte a este espacio de trabajo.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isPending ? (
