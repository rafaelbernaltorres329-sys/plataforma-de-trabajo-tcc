      ...
      <div className="flex flex-col lg:flex-row lg:items-center space-y-2 lg:space-x-8 lg:space-y-0">
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              <span className="sr-only">Ir ala primera pagina</span>
              <ChevronsLeft />
            </Button>
            <Button
              variant="outline"
              ...
              disabled={pageIndex === 0}
            >
              <span className="sr-only">Ir ala anterior pagina</span>
              <ChevronLeft /> antes
            </Button>
            <Button
              variant="outline"
            ...
            >
              <span className="sr-only">Ir ala siguiente pagina</span>
              Siguiente
              <ChevronRight />
            </Button>
            <Button
              ...
              disabled={pageIndex >= pageCount - 1}
            >
              <span className="sr-only">Ir ala ultima pajina</span>
              <ChevronsRight />
            </Button>
          </div>
        </div>
