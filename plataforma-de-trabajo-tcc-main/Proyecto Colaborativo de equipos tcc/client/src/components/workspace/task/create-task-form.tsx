...
export default function CreateTaskForm(props: {
  ...
  const formSchema = z.object({
    ...
    priority: z.enum(
      ...
      {
        required_error: "Prioridad es requerido",
      }
    ),
    assignedTo: z.string().trim().min(1, {
      message: "Assignado a  es requerido",
    }),
    dueDate: z.date({
      required_error: "una fecha de nacimiento es requerido.",
    }),
  });
      ...
      <div className="h-full">
        <div className="mb-5 pb-2 border-b">
          ...
          <p className="text-muted-foreground text-sm leading-tight">
            Organiza y administra tareas , recursos, y equipos colaborativos
          </p>
        </div>
        <Form {...form}>
          <form className="space-y-3" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Assignado a</FormLabel>
                    <Select
                      onValueChange={field.onChange}
                      defaultValue={field.value}
                    >
